...
Being my biggest web-dev project to date, I challenged myself to learn a lot of new concepts such as mobile-first design, web optimization, and many of Next 13's features that I previously did not have a chance to play with.`,
    techLogos: [<NextIcon />],
    repoLink: '',
